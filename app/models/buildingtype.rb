class Buildingtype < ActiveRecord::Base
  ...
  def self.init()
    ...
    Buildingtype.create({:name =>'Headquarter', :level=> 2, :production=> 1, :energyusage=> 50, :build_time=>300, :build_cost_ore =>100, :build_cost_crystal =>0, :build_cost_money =>1024, :build_cost_population =>50})
    ...
    Buildingtype.create({:name =>'Powerplant', :level => 2, :production=> 750, :energyusage=>0, :build_time=>300, :build_cost_ore =>100, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>50})
    ...
    Buildingtype.create({:name =>'ResearchLab', :level => 1, :production=> 0, :energyusage=> 75, :build_time=>5, :build_cost_ore =>100, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>100})
    Buildingtype.create({:name =>'ResearchLab', :level => 2, :production=> 0, :energyusage=> 200, :build_time=>3000, :build_cost_ore =>200, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>200})
    ...
    Buildingtype.create({:name =>'City', :level=> 1, :production=> 50, :energyusage=> 20, :build_time=>0, :build_cost_ore =>0, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>0})
    Buildingtype.create({:name =>'City', :level=> 2, :production=> 100, :energyusage=> 50, :build_time=>300, :build_cost_ore =>100, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>50})
    Buildingtype.create({:name =>'City', :level=> 3, :production=> 150, :energyusage=> 100, :build_time=>2500, :build_cost_ore =>500, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>100})
    Buildingtype.create({:name =>'City', :level=> 4, :production=> 200, :energyusage=> 250, :build_time=>10000, :build_cost_ore =>2500, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>200})
    Buildingtype.create({:name =>'City', :level=> 5, :production=> 300, :energyusage=> 500, :build_time=>50000, :build_cost_ore =>10000, :build_cost_crystal =>1, :build_cost_money =>0, :build_cost_population =>500})
    ...
    Buildingtype.create({:name =>'Crystalmine', :level=> 3, :production=> 3, :energyusage=> 400, :build_time=>12500, :build_cost_ore =>0, :build_cost_crystal =>5, :build_cost_money =>0, :build_cost_population =>300})
    Buildingtype.create({:name =>'Crystalmine', :level=> 4, :production=> 4, :energyusage=> 700, :build_time=>40000, :build_cost_ore =>0, :build_cost_crystal =>7, :build_cost_money =>0, :build_cost_population =>400})
    Buildingtype.create({:name =>'Crystalmine', :level=> 5, :production=> 5, :energyusage=> 1000, :build_time=>75000, :build_cost_ore =>0, :build_cost_crystal =>10, :build_cost_money =>0, :build_cost_population =>500})

    Buildingtype.create({:name =>'Starport', :level=> 1, :production=> 0, :energyusage=> 50, :build_time=>300, :build_cost_ore =>0, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>50})
    Buildingtype.create({:name =>'Starport', :level=> 2, :production=> 0, :energyusage=> 120, :build_time=>3000, :build_cost_ore =>0, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>100})
    Buildingtype.create({:name =>'Starport', :level=> 3, :production=> 0, :energyusage=> 200, :build_time=>15000, :build_cost_ore =>0, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>200})
    Buildingtype.create({:name =>'Starport', :level=> 4, :production=> 0, :energyusage=> 350, :build_time=>32000, :build_cost_ore =>0, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>300})
    Buildingtype.create({:name =>'Starport', :level=> 5, :production=> 0, :energyusage=> 500, :build_time=>60000, :build_cost_ore =>0, :build_cost_crystal =>2, :build_cost_money =>0, :build_cost_population =>500})
