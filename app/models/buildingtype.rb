class Buildingtype < ActiveRecord::Base
  ...
  def self.init()
    ...
    Buildingtype.create({:name =>'City', :level=> 2, :production=> 200, :energyusage=> 50, :build_time=>300, :build_cost_ore =>100, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>50})
    Buildingtype.create({:name =>'City', :level=> 3, :production=> 300, :energyusage=> 100, :build_time=>2500, :build_cost_ore =>500, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>100})
    Buildingtype.create({:name =>'City', :level=> 4, :production=> 400, :energyusage=> 250, :build_time=>10000, :build_cost_ore =>2500, :build_cost_crystal =>0, :build_cost_money =>0, :build_cost_population =>200})
    Buildingtype.create({:name =>'City', :level=> 5, :production=> 500, :energyusage=> 500, :build_time=>50000, :build_cost_ore =>10000, :build_cost_crystal =>1, :build_cost_money =>0, :build_cost_population =>500})
