class ShipsController < ApplicationController
  ...
  private
    ...
    def ship_params
      params.require(:ship).permit(:construction_time, :offense, :defense, :crystal_cost, :credit_cost, :ore_cost, :name, :velocity, :crew_capacity, :ressource_capasity, :fuel_capacity, :consumption)
    end
end
