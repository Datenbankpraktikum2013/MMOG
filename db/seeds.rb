...
Ship.create({:id => 1, :construction_time => 240, :offense => 1, :defense => 10, :crystal_cost => 0, :credit_cost => 500, :ore_cost => 60, :name => 'Small cargo ship', :velocity => 3, :crew_capacity => 1, :ressource_capacity => 8000, :fuel_capacity => 500, :consumption => 2})
Ship.create({:id => 2, :construction_time => 480, :offense => 1, :defense => 30, :crystal_cost => 0, :credit_cost => 2000, :ore_cost => 600, :name => 'Large cargo ship', :velocity => 3, :crew_capacity => 8, :ressource_capacity => 40000, :fuel_capacity => 3000, :consumption => 3})
Ship.create({:id => 3, :construction_time => 240, :offense => 30, :defense => 30, :crystal_cost => 0, :credit_cost => 100, :ore_cost => 200, :name => 'Fighter', :velocity => 6, :crew_capacity => 1, :ressource_capacity => 10, :fuel_capacity => 100, :consumption => 1})
Ship.create({:id => 4, :construction_time => 540, :offense => 70, :defense => 30, :crystal_cost => 0, :credit_cost => 400, :ore_cost => 700, :name => 'Destroyer', :velocity => 5, :crew_capacity => 15, :ressource_capacity => 50, :fuel_capacity => 2000, :consumption => 4})
Ship.create({:id => 5, :construction_time => 900, :offense => 150, :defense => 60, :crystal_cost => 1, :credit_cost => 700, :ore_cost => 1000, :name => 'Cruiser', :velocity => 6, :crew_capacity => 20, :ressource_capacity => 150, :fuel_capacity => 3000, :consumption => 4})
Ship.create({:id => 6, :construction_time => 5000, :offense => 10000, :defense => 7000, :crystal_cost => 2000, :credit_cost => 80000, :ore_cost => 90000, :name => 'Deathstar', :velocity => 3, :crew_capacity => 500, :ressource_capacity => 2500, :fuel_capacity => 5000, :consumption => 10})
Ship.create({:id => 7, :construction_time => 480, :offense => 0, :defense => 0, :crystal_cost => 0, :credit_cost => 50, :ore_cost => 100, :name => 'Spy drone', :velocity => 15, :crew_capacity => 0, :ressource_capacity => 0, :fuel_capacity => 500, :consumption => 1})
Ship.create({:id => 8, :construction_time => 480, :offense => 1, :defense => 100, :crystal_cost => 0, :credit_cost => 0, :ore_cost => 150, :name => 'Small defense platform', :velocity => 0, :crew_capacity => 3, :ressource_capacity => 0, :fuel_capacity => 0, :consumption => 0})
Ship.create({:id => 9, :construction_time => 900, :offense => 1, :defense => 400, :crystal_cost => 0, :credit_cost => 0, :ore_cost => 700, :name => 'Large defense platform', :velocity => 0, :crew_capacity => 6, :ressource_capacity => 0, :fuel_capacity => 0, :consumption => 0})
Ship.create({:id => 10, :construction_time => 900, :offense => 1, :defense => 10, :crystal_cost => 0, :credit_cost => 1000, :ore_cost => 2000, :name => 'Colony ship', :velocity => 2, :crew_capacity => 5, :ressource_capacity => 1000, :fuel_capacity => 3000, :consumption => 4})
