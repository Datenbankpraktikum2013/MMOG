...
ActiveRecord::Schema.define(version: 20130807141025) do
  ...
  create_table "receiving_reports", force: true do |t|
    t.integer  "report_id"
    t.integer  "user_id"
    t.boolean  "read",       default: false
    t.datetime "created_at"
  ...
  add_index "receiving_reports", ["report_id"], name: "index_receiving_reports_on_report_id"
  add_index "receiving_reports", ["user_id"], name: "index_receiving_reports_on_user_id"
