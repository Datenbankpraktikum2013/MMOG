...
class BuildingsControllerTest < ActionController::TestCase
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post :create, building: { id: @building.id, letzteaktion: @building.letzteaktion, typeid: @building.typeid }
    end
  ...
  test "should update building" do
    patch :update, id: @building, building: { id: @building.id, letzteaktion: @building.letzteaktion, typeid: @building.typeid }
    assert_redirected_to building_path(assigns(:building))
  end
