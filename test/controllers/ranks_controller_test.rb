...
class RanksControllerTest < ActionController::TestCase
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post :create, rank: { delete: @rank.delete, edit: @rank.edit, invite: @rank.invite, kick: @rank.kick, massmail: @rank.massmail, name: @rank.name }
    end
  ...
  test "should update rank" do
    patch :update, id: @rank, rank: { delete: @rank.delete, edit: @rank.edit, invite: @rank.invite, kick: @rank.kick, massmail: @rank.massmail, name: @rank.name }
    assert_redirected_to rank_path(assigns(:rank))
  end
